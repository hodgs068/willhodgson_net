		...
		if(isset($_POST['username']) &&
			...
			if (!empty($username) &&
				...
				if ((strlen($username) > 30) || (strlen($firstname) > 40) || (strlen($surname > 40))){
					echo 'Please adhere to the correct maxlength for forms';
				} else {
					...
					if($password!=$password_again){
						...
						if(mysql_num_rows($query_run) == 1){
							...
							$query = "INSERT INTO users VALUES ('','".mysql_real_escape_string($username)."',
							...
							if($query_run = mysql_query($query)){
								...
								'Sorry, we couldn\'t register you at this time. Try again later.';
							}
						}
					}
				}
